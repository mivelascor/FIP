...
/* ── Footer ── */
.page-footer{width:100%;border-top:0.5pt solid #e0e0e0;padding:5pt 0 4pt;margin-top:10pt;}
.page-footer-left{width:100%;border-top:0.5pt solid rgba(255,255,255,0.15);padding:5pt 0 4pt;margin-top:10pt;}
.footer-txt{font-size:5pt;line-height:1.45;color:#b0b0b0;font-family:'Barlow',sans-serif;}
.footer-txt-left{font-size:5pt;line-height:1.45;color:rgba(255,255,255,0.30);font-family:'Barlow',sans-serif;}
