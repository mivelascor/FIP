...
FUND_ODS_NAMES = {
    ...
    'TEMPLATE FONDO LIQUIDEZ FLEXIBLE DOLAR.xlsx': 'FIP VANTRUST LIQUIDEZ FLEXIBLE DOLAR',
    'TEMPLATE FONDO LIQUIDEZ SENCILLO.xlsx':      'FIP VANTRUST LIQUIDEZ SENCILLO',
    'TEMPLATE FONDO LIQUIDEZ RECURRENTE.xlsx':    'FIP VANTRUST LIQUIDEZ RECURRENTE',
    'TEMPLATE FONDO LIQUIDEZ TEMPORAL.xlsx':      'FIP VANTRUST LIQUIDEZ TEMPORAL',
    'TEMPLATE FONDO LIQUIDEZ HORIZONTE.xlsx':     'FIP VANTRUST LIQUIDEZ HORIZONTE',
}
...
USD_TEMPLATES = {
    ...
    'TEMPLATE FONDO LIQUIDEZ FLEXIBLE DOLAR.xlsx',
}
