...
FUND_TEMPLATE_MAP = {
    ...
    # USD funds — template has both summary AND full historico
    ...
    # CLP funds found in unexpected templates
    'FIP VANTRUST LIQUIDEZ I':             'TEMPLATE_FONDO_USD_MONEY_MARKET.xlsx',
    'FIP VANTRUST LIQUIDEZ ALTO CAPITAL':  'TEMPLATE_FONDO_FACTURA_DOLAR.xlsx',
}
